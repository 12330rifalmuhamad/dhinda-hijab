            ...
            {articles.map((article, index) => (
              <SwiperSlide key={article.id} className="h-auto">
                <motion.article
                  ...
                  className="group flex flex-col h-full bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300"
                >
                  <Link href={`/stories/${article.slug}`} className="block overflow-hidden relative aspect-[3/2]">
                  ...
                  <div className="flex flex-col flex-grow p-6">
                    ...
                    <h3 className="text-xl font-medium text-gray-900 mb-3 leading-snug group-hover:text-[#dca5ad] transition-colors">
