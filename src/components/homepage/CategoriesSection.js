  ...
  return (
    <section id="categories" className="py-8 md:py-12">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <motion.div className="flex lg:grid lg:grid-cols-4 gap-6 mt-12 overflow-x-auto lg:overflow-visible pb-4 lg:pb-0 snap-x snap-mandatory" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
