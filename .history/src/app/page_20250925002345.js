...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 sm:px-6 mt-8 overflow-hidden"> {/* Sedikit penyesuaian padding */}
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-150px)]">
          ...
          <motion.div 
            ...
            animate="visible"
          >
            <div className="absolute -left-4 sm:-left-6 top-0 bottom-0 w-1 bg-gray-200 rounded-full"></div>
            {/* PERUBAHAN 1: Ukuran font diubah agar tidak terlalu besar di mobile */}
            <motion.h1 variants={itemVariants} className="text-7xl sm:text-8xl md:text-9xl font-black tracking-tighter leading-none">
              MODEST
            </motion.h1>
            ...
            {/* PERUBAHAN 2: Layout diubah menjadi kolom di mobile, dan baris di layar lebih besar */}
            <motion.div variants={itemVariants} className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-8 sm:gap-12">
          ...
          >
            <Image
              ...
              priority
            />
            {/* PERUBAHAN 3: Ukuran font overlay juga disesuaikan untuk mobile */}
            <motion.h2 
              className="absolute bottom-4 right-4 sm:bottom-8 sm:right-8 text-6xl sm:text-7xl md:text-8xl font-black text-black/30 tracking-tighter leading-none"
