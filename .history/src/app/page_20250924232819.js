      ...
      <main className="container mx-auto px-6 mt-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-150px)]">
          ...
          <div className="relative">
            ...
            <div className="mt-8">
              ...
              <p className="mt-2 max-w-md text-gray-600">
                The hijab is more than just a piece of clothing — it's a symbol of modesty, faith, and identity. Designed for comfort and elegance, it reflects the beauty of inner strength an personal choice. Our hijabs are crafted with premium fabrics to ensure a lightweight, breathable feel all day long.
              </p>
            </div>
          ...
          <div className="relative w-full h-[50vh] lg:h-[75vh]">
            <Image
              src="/hijab-model.jpg" // PASTIKAN NAMA FILE SESUAI
