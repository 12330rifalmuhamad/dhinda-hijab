...
import { mostWantedProducts, categories, features, storeLocations } from '@/data/home';

// Komponen Page sekarang menjadi Server Component
export default function HomePage() {

  // Nantinya, data di atas bisa diganti dengan fetch dari API database Anda
