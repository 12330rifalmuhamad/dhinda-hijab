...
export default function Footer() {
  return (
    ...
    <footer className="bg-[#312231] text-gray-300">
          ...
          <div>
            ...
            <form className="mt-4 flex">
              <input 
                ...
                className="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-l-md focus:outline-none focus:ring-2 focus:ring-[#FBC2EB]/50"
              />
              <button className="bg-[#FBC2EB] text-[#312231] px-4 py-2 rounded-r-md font-semibold hover:bg-[#F4A8D9] transition-colors">
                Daftar
              </button>
            </form>
