...
export default function MostWantedSection() {
  ...
  useEffect(() => {
    // Buat AbortController untuk membatalkan fetch jika perlu
    ...
    const fetchProducts = async () => {
      try {
        setIsLoading(true);
        // Kirim "signal" bersama dengan request fetch
        ...
        // Abaikan error yang disebabkan oleh pembatalan (abort)
    ...
    return () => {
      controller.abort(); // Batalkan fetch jika komponen unmount/rerender
    };
